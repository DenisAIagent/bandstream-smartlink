...
The data controller for personal data is BandStream SAS, 60 rue François 1er, 75008 Paris, France. RCS Paris 939 221 438 — SIRET 939 221 438 00012 — VAT FR 81939221438 — Contact: contact@band.stream.

**Article 2 — Data Protection Officer**

The DPO can be reached at: dpo@band.stream. The DPO is the point of contact for any questions regarding the processing of personal data and for the exercise of data subjects' rights.
...
Further information: dpo@band.stream.
...
Requests should be sent to dpo@band.stream with proof of identity. Response within one (1) month, extendable by two (2) months. Complaints may be filed with the CNIL (3 Place de Fontenoy, 75334 Paris Cedex 07 — www.cnil.fr).
...
Customer service: contact@band.stream
